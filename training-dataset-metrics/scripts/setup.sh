...
$venv_dir/bin/uv pip install --python "$venv_dir/bin/python" --all-extras --requirements pyproject.toml

$venv_dir/bin/uv pip install --python "$venv_dir/bin/python" --editable .
